...
export class ProductoService {
  ...
  listar_productos_admin(filtro: any, token: any): Observable<any> {
    ...
    return this._http.get(this.url + 'listar_productos_admin/' + filtro, {
      headers: headers,
    });
  }
  ...
  actualizar_variedades_admin(data: any, id: any, token: any): Observable<any> {
    let headers = new HttpHeaders({
      'Content-Type': 'application/json',
      Authorization: token,
    });
    return this._http.put(
      this.url + 'actualizar_variedades_admin/' + id,
      data,
      {
        headers: headers,
      }
