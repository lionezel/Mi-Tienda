...
export class CuponService {
  ...
  registro_cupon_admin(data: any, token: any): Observable<any> {
    ...
    return this._http.post(this.url + 'registro_cupon_admin', data, {
      headers: headers,
    });
  }
  ...
  obtener_cupon_admin(id: any, token: any): Observable<any> {
    ...
    return this._http.get(this.url + 'obtener_cupon_admin/' + id, {
      headers: headers,
    });
  }
  ...
  eleminar_cupon_admin(id: any, token: any): Observable<any> {
    let headers = new HttpHeaders({
      'Content-Type': 'application/json',
      Authorization: token,
    });
    return this._http.delete(this.url + 'eleminar_cupon_admin/' + id, {
      headers: headers,
    });
  }
}
