...
api.put(
  "/actualizar_variedades_admin/:id",
  auth.auth,
  productoController.actualizar_variedades_admin
);
...
api.get(
  "/obtener_productos_slug_publico/:slug",
  productoController.obtener_productos_slug_publico
);
